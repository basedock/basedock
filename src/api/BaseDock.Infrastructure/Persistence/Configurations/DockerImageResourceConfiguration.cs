...
public class DockerImageResourceConfiguration : IEntityTypeConfiguration<DockerImageResource>
{
    public void Configure(EntityTypeBuilder<DockerImageResource> builder)
    {
        builder.ToTable("docker_image_resources");
